            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mb-0 text-success">Rp {{ number_format($income ?? 0, 0, ',', '.') }}</h4>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mb-0 text-danger">Rp {{ number_format($expense ?? 0, 0, ',', '.') }}</h4>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mb-0 {{ ($profit ?? 0) >= 0 ? 'text-success' : 'text-danger' }}">Rp {{ number_format($profit ?? 0, 0, ',', '.') }}</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex gap-2 align-items-center">
                    ...
                    <a href="{{ route('report.export', 'financial') }}" class="btn btn-sm btn-outline-primary">
...
@section('customjs')
    <script type="text/javascript">
        var dtable;
        const urlAjax = '{{ route('report.financial.data') }}';
