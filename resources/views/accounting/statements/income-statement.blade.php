                        ...
                        <table class="table table-xxs">
                            ...
                            <tbody>
                                ...
                                <tr class="table-success fw-bold">
                                    ...
                                    <td class="text-end">{{ \App\Support\AppSettings::money($report['total_income']) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table table-xxs">
                            ...
                            <tbody>
                                ...
                                <tr class="table-danger fw-bold">
                                    ...
                                    <td class="text-end">{{ \App\Support\AppSettings::money($report['total_expense']) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="card mt-4">
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <h4 class="mb-0 {{ $report['net_profit'] >= 0 ? 'text-success' : 'text-danger' }}">
                    {{ \App\Support\AppSettings::money($report['net_profit']) }}
                </h4>
            </div>
        </div>
    </div>
