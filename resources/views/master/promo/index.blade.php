...
@section('customjs')
    <script type="text/javascript">
        var dtable;
        const urlAjax = '{{ route('master.promo.data') }}';
        ...
        @php
                ...
                if (auth()->user()->can('master_edit')) $btnList['toggle'] = 'master.promo.toggle';
            @endphp
